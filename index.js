...
function historyStatus() {
  let buttonStatus = document.querySelector(".history-main-container");
  if (buttonStatus.style.display === "flex") {
    document.querySelector(".search__history").innerHTML = 'Close'
  } else {
